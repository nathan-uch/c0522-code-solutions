...
export default class App extends React.Component {
    ...
    */
    fetch('/api/todos', {
      ...
      .then(data => {
        ...
        const todos = curTodos.concat(data);
        this.setState({ todos });
      })
      .catch(err => console.error('ERROR:', err));
  }
  ...
  toggleCompleted(todoId) {
    ...
    const index = todos.map(todo => todo.todoId).indexOf(todoId);
    const toggle = todos[index].isCompleted ? { isCompleted: false } : { isCompleted: true };
